        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <h5><?php echo empty($link->id) ? 'Toevoegen' : 'Wijzigen ' . $link->naam; ?></h5>
                ...
                <div class="ibox-content">
                    ...
                    <div class="form-group ">
                        ...
                        <div class="col-md-10">
                            <?php echo form_input('naam', set_value('naam', $link->naam)); ?>
                        </div>
                    </div> <!-- formrow -->
                    ...
                    <div class="form-group ">
                        ...
                        <div class="col-md-10">
                            <?php echo form_input('link', set_value('link', $link->link)); ?>
                        </div>
                    </div> <!-- formrow -->
                    ...
                    <div class="form-group ">
                        ...
                        <div class="col-md-10">
                            <div class="input-group m-b">
                                ...
                                <?php echo form_input('foto', set_value('foto', $link->foto)); ?>
                            </div>
                        </div>
                    </div> <!-- formrow -->
